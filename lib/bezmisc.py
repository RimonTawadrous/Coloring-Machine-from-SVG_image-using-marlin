...
def bezierparameterize(Q1):
    #parametric bezier
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = Q1
    x0=bx0
    y0=by0
    cx=3*(bx1-x0)
    bx=3*(bx2-bx1)-cx
...
def linebezierintersect(Q1, Q2):
    #parametric line
    ((lx1, ly1), (lx2, ly2)) = Q1
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = Q2
    dd=lx1
    cc=lx2-lx1
    bb=ly1
    aa=ly2-ly1
...
def bezierlengthSimpson(Q1 , tolerance = 0.001):
...
def beziertatlength(Q1, l = 0.5, tolerance = 0.001):
    global balfax,balfbx,balfcx,balfay,balfby,balfcy
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = Q1
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
    balfax,balfbx,balfcx,balfay,balfby,balfcy = 3*ax,2*bx,cx,3*ay,2*by,cy
